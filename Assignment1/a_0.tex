...
For n=0 to n=4,
\begin{align}
    y\brak{n} &= x\brak{n} * u\brak{n}\label{eq4}\\
    \implies Y\brak{z} &= X\brak{z} U \brak{z}\\
    Y\brak{z} &= \frac{x\brak{0}}{\brak{1-z^{-1}}^2} + \frac{dz^{-1}}{\brak{1-z^{-1}}^3}
\end{align}
For n=5 to n=9,
\begin{align}
    y\brak{n+5} &= x\brak{n+5} * u\brak{n}\label{eq2}\\
    \implies Y\brak{z} &= X\brak{z} U \brak{z}\\
    Y\brak{z} &= \frac{\brak{x\brak{0}+4d}}{\brak{1-z^{-1}}^2} + \frac{dz^{-1}}{\brak{1-z^{-1}}^3}\\
\end{align}
On taking inverse Z-transform and substituting n=4
\begin{align}
