...
\begin{figure}[H]
    \includegraphics[width=0.75\columnwidth]{figs/Before_audiofilter.jpg}
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[H]
\includegraphics[width=0.75\columnwidth]{figs/After_audiofilter.jpg}
...
\begin{align}
	...
	&= \brak{1.45\times 10^{-5}}x(n) + \brak{6.22 \times 10^{-5}}x(n - 1) \nonumber \\
...
\\
\solution
The given butterworth filter is low pass with order=4 and cutoff-frequency=5kHz.
%
\item
Modifying the code with different input parameters to get the best possible output.
\\
\solution
