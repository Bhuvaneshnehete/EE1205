...
\begin{enumerate}
    ...
    \item system is said to be stable if it follows BIBO rule (output should be bounded for bounded input) but in option \brak{C} output of h[n] is not defined, so it not necessarily to be stable.
    \item system is said to be stable if it follows BIBO rule (output should be bounded for bounded input) but in option \brak{D} range of n is not defined, so it is not necessarily to be stable.
\end{enumerate}
